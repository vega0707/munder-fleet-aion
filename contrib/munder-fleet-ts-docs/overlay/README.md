...
2. [`docs/DESIGN_DIRECTION.md`](./docs/DESIGN_DIRECTION.md)（**设计方向定稿**）· [`docs/ARCHITECTURE.md`](./docs/ARCHITECTURE.md) · [`docs/COPY_MAP.md`](./docs/COPY_MAP.md) · [`docs/COMPARISON.md`](./docs/COMPARISON.md) · [`docs/WORKBUDDY_ANALYSIS.md`](./docs/WORKBUDDY_ANALYSIS.md)
